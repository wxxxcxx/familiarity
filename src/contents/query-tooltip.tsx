import type { PlasmoRender, PlasmoGetStyle, PlasmoGetInlineAnchorList, PlasmoMountShadowHost, PlasmoWatchOverlayAnchor, PlasmoCSUIJSXContainer, PlasmoGetInlineAnchor } from "plasmo";
...
const querySelection = () => {
    ...
    if (selection == null || selection.toString().trim() == '' || selection.rangeCount == 0) {
        return
    }
